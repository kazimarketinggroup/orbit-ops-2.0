...
const findingBullets = [
  "The same customer record exists differently in five systems and nobody knows which is right.",
  "Reporting takes a week because someone has to reconcile exports by hand.",
  "Point-to-point connections built years ago now fail silently and often.",
  "AI initiatives stall because the data underneath them can't be trusted.",
  "Every new tool adds another manual bridge staffed by a person.",
];
...
const deliverCards = [
  {
    ...
    image: "/images/solution/systemIntegration/deliver-integration-architecture.png",
  },
  {
    title: "Data model and quality",
    image: "/images/solution/systemIntegration/deliver-data-model-quality.png",
  },
  {
    title: "API and event build",
    image: "/images/solution/systemIntegration/deliver-api-event-build.png",
  },
  {
    title: "AI-ready data layer",
    image: "/images/solution/systemIntegration/deliver-ai-ready-data-layer.png",
  },
  {
    title: "Security and access",
    image: "/images/solution/systemIntegration/deliver-security-access.png",
  },
  {
    title: "Vendor assessment",
    image: "/images/solution/systemIntegration/deliver-vendor-assessment.png",
  },
];
...
const engagementSteps = [
  {
    ...
    description:
      "Systems, flows, owners and failure points documented with the people who live them.",
    output: "Current-state map and risk register.",
    image: "/images/solution/systemIntegration/step-landscape-review.png",
  },
  {
    phase: "Weeks 4-6",
    title: "Target architecture",
    description:
      "System of record decisions, integration patterns and a sequenced migration plan.",
    output: "Architecture pack and costed roadmap.",
    image: "/images/solution/systemIntegration/step-target-architecture.png",
  },
  {
    phase: "Weeks 7-20",
    title: "Build and migrate",
    description:
      "Interfaces delivered domain by domain, with old bridges retired as we go.",
    output: "Live integrations with monitoring and alerting.",
    image: "/images/solution/systemIntegration/step-build-migrate.png",
  },
  {
    phase: "Ongoing",
    title: "Run and govern",
    description:
      "Your team owns it; we review architecture decisions as the estate changes.",
    output: "Governance forum and documented standards.",
    image: "/images/solution/systemIntegration/step-run-govern.png",
  },
];

function SystemIntegrationHero() {
  return (
    <section className="relative min-h-[calc(100svh-var(--nav-h))] overflow-hidden bg-[#f6f2fb]">
      <Image
        src="/images/solution/systemIntegration/hero-bg.png"
        alt=""
        fill
        priority
        sizes="100vw"
      ...
      />
      <div className="absolute inset-0 bg-[#f6f2fb]/58" />
      ...
      <div className="relative mx-auto grid min-h-[calc(100svh-var(--nav-h))] max-w-6xl items-center gap-10 px-6 py-16 lg:grid-cols-[1fr_0.72fr] lg:px-8">
        <div className="max-w-2xl">
          <p className="text-xs font-semibold text-[#0f2142]/70">
            Solutions &middot; System Integration
          </p>
          <h1 className="mt-4 max-w-xl font-heading text-[2rem] font-medium leading-[1.12] tracking-normal text-zinc-950 sm:text-[2.45rem] lg:text-[2.75rem]">
            Integration consulting for organisations tired of duplicate data
            entry.
          </h1>
          <p className="mt-5 max-w-xl text-sm leading-6 text-[#0f2142]/75">
            We map how information really moves between your systems and
            people, design the target architecture, and build the
            integrations &mdash; so AI has trustworthy data to work with
            instead of six conflicting versions.
          </p>
          <div className="mt-8">
            <a
              href="/demo"
        ...
        <div className="relative hidden aspect-4/3 self-center overflow-hidden rounded-lg shadow-[0_24px_60px_-24px_rgba(15,23,42,0.35)] lg:block">
          <Image
            src="/images/solution/systemIntegration/hero-photo.png"
            alt=""
            fill
            priority
...
function FindingsSection() {
  return (
    <section className="bg-[#f6f2fb] py-16">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <h2 className="mx-auto max-w-3xl text-center font-heading text-[1.7rem] font-medium leading-tight tracking-normal text-zinc-900 sm:text-[2rem]">
          6+ Systems the average client keys the same record into before we
          start.
        </h2>
        ...
        <div className="mt-16 grid items-start gap-12 lg:grid-cols-[1fr_0.92fr]">
          <div>
            <h3 className="font-heading text-[1.7rem] font-medium leading-tight tracking-normal text-zinc-900 sm:text-[2rem]">
              The symptoms clients come to us with.
            </h3>
          ...
          <div className="overflow-hidden rounded-lg border border-black/[.06] bg-[#f6e7f5] shadow-sm">
            ...
            <div className="px-8 py-10">
              ...
              <p className="mt-5 text-xs leading-5 text-zinc-600">
                Integration is an architecture and ownership problem before
                it&apos;s an engineering one. We agree the system of record
                for each domain, design the contracts between systems, and
                build resilient, observable interfaces. The measure of
                success is that people stop re-keying and reports stop
...
function AdviceSection() {
  return (
    <section className="bg-[#f6f2fb] pb-4 pt-10">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
...
function DeliverSection() {
  return (
    <section className="bg-[#f6f2fb] py-14">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
