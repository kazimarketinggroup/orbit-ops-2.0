...
import PrivateEquityDeliveryTabs from "@/components/industry/PrivateEquityDeliveryTabs";

const partnerNeeds = [
  {
    number: "01",
    title: "Diligence beyond the vendor deck",
    body: "You need an independent view of whether a target's technology and AI claims are real, and what remediation will cost post-close.",
  },
  {
    number: "02",
    title: "Portfolio teams without capability",
    body: "Management teams are strong operationally but have no one who can lead an AI or automation agenda credibly.",
  },
  {
    number: "03",
    title: "Value creation plans that stay theoretical",
    body: "The 100-day plan lists digitalisation with no owner, no sequencing and no numbers behind it.",
  },
  {
    number: "04",
    title: "Bolt-on integration drag",
    body: "Each acquisition arrives with its own systems, and integration costs quietly eat the synergy case.",
  },
  {
    number: "05",
    title: "Inconsistent reporting across the portfolio",
    body: "Every company reports differently, so fund-level visibility depends on manual consolidation.",
  },
  {
    number: "06",
    title: "Exit narrative gaps",
    body: "Buyers now probe AI maturity and data quality; weak answers show up in the multiple.",
  },
];
...
const platformCards = [
  {
    ...
    body: "A shared operating layer we can roll out company by company across the portfolio.",
    href: "/platform/autonomous-operation-system",
    cta: "Explore the platform",
  },
  {
    title: "Deal Pipeline Solution",
    body: "Commercial pipeline discipline for portfolio companies where revenue forecasting is the weak point.",
...
const fundBullets = [
  "NDAs, clean teams and confidential process experience as standard",
  "Findings written for the IC, with technical appendices where needed",
  "Fixed-fee diligence with committed turnaround dates",
  "No vendor relationships or referral fees - our advice is unconflicted",
  "Ability to mobilise into a portfolio company within two weeks",
];

function PrivateEquityHero() {
  return (
    <section className="flex min-h-[calc(100svh-var(--nav-h))] items-center bg-[#efffe5]">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 px-6 py-16 lg:grid-cols-[0.95fr_1fr] lg:px-8">
        <div>
          ...
          <h1 className="mt-4 max-w-xl font-heading text-[1.85rem] font-medium leading-[1.12] tracking-normal text-zinc-950 sm:text-[2.2rem] lg:text-[2.45rem]">
            AI advisory for funds who need value creation, not another
            portfolio tool.
          </h1>
          <p className="mt-5 max-w-lg text-xs leading-5 text-[#0f2142]/75">
            We work with deal teams and operating partners across diligence, the
            first hundred days and exit readiness bringing operational AI
            expertise into portfolio companies that don&apos;t have it in-house.
          </p>
          <div className="mt-8">
            <a
              href="/demo"
        ...
        <div className="relative min-h-[360px] lg:min-h-[470px]">
          <Image
            src="/images/industry/privateEquity/Group 157.png"
            alt=""
            fill
            priority
...
function PartnerNeedsSection() {
  return (
    <section className="bg-[#f3ffe9] py-14">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="grid overflow-hidden rounded-lg bg-[#f7fff0] lg:grid-cols-[0.95fr_1fr]">
          <div className="relative min-h-[300px] bg-[#dfffbb]">
            <Image
              src="/images/industry/privateEquity/Group 77.png"
              alt=""
              fill
        ...
        <div className="grid border border-[#dcebd2] bg-[#f7fff0] sm:grid-cols-2 lg:grid-cols-3">
          {partnerNeeds.map((item) => (
            <article
              key={item.number}
              className="min-h-[160px] border-b border-r border-[#dcebd2] p-6 last:border-r-0"
            >
    ...
    <section className="bg-[#f3ffe9] py-16">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl text-xs leading-5 text-zinc-600">
          ...
          we can drop in when they save you build time.
        </p>

        <PrivateEquityDeliveryTabs />
      </div>
    </section>
  );
}

function FundWorkflowSection() {
  return (
    <section className="bg-white py-16">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-[0.9fr_1fr] lg:px-8">
        <div>
          <h2 className="font-heading text-[1.5rem] font-medium leading-tight tracking-normal text-zinc-900 sm:text-[1.75rem]">
            Built for the way funds actually work.
          </h2>
          <p className="mt-4 max-w-lg text-xs leading-5 text-zinc-600">
            We are used to compressed timelines, confidential processes and
            management teams who have limited bandwidth. Our consultants report
            in the language of the investment committee, not the engineering
            team.
          </p>
          <ul className="mt-6 space-y-3 text-xs leading-5 text-zinc-600">
            {fundBullets.map((item) => (
        ...
        <Image
          src="/images/industry/privateEquity/ChatGPT Image Jul 28, 2026, 03_54_11 PM 1.png"
          alt=""
          width={900}
          height={506}
